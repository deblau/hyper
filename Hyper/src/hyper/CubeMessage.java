...
class CubeMessage implements Serializable
{
	...
	public enum Type {
		...
		// Message from ANN to client, providing the dimension of the Cube
		// Src: ANN
		// Dest: connected client
		// Data: dimension of the Cube
		CONN_ANN_EXT_DIM,

		// Message from ANN to new neighbors, instructing each to advertise its Cube address
		// Src: ANN
		// Dest: Connected node two hops from ANN
		// Data: InetSocketAddress of client's MessageListener
		CONN_ANN_NBR_ADV,
		...
		// Message from new neighbor to ANN, indicating that the client was informed and state is correct
		// Src: neighbor's CubeAddress
		// Dest: client's CubeAddress
		// Data: null
		CONN_NBR_ANN_ACK5,
